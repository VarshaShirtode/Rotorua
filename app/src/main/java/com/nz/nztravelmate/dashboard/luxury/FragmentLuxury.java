package com.nz.nztravelmate.dashboard.luxury;
...
public class FragmentLuxury extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView=inflater.inflate(R.layout.fragment_luxury, container, false);
        initUI();
        getData();
        setData();
        return rootView;
    ...
    private void getData() {
        ...
        Food food1=new Food();
        food1.setName("Luxury 2 Service");
