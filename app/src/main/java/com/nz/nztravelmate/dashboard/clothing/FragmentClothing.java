package com.nz.nztravelmate.dashboard.clothing;
...
public class FragmentClothing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView=inflater.inflate(R.layout.fragment_clothing, container, false);
        initUI();
        getData();
        setData();
        return rootView;
    ...
    private void getData() {
        ...
        Food food=new Food();
        food.setName("Clothing 1 Service");
        ...
        Food food1=new Food();
        food1.setName("Clothig 2 Service");
